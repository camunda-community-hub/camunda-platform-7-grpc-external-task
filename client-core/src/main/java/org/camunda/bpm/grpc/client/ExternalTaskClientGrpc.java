...
/**
 * <p>Camunda external task client consuming a gRPC API</p>
 */
public interface ExternalTaskClientGrpc {

  /**
   * Creates a fluent builder to configure the Camunda gRPC client
   *
