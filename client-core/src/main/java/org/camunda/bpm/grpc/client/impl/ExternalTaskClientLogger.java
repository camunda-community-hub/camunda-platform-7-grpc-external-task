...
import org.camunda.bpm.grpc.client.topic.impl.TopicSubscriptionManagerLogger;
...
public class ExternalTaskClientLogger extends BaseLogger {
  ...
  protected static final String PROJECT_CODE = "TASK/CLIENT/GRPC";
  protected static final String PROJECT_LOGGER = "org.camunda.bpm.grpc.client";
  ...
  public static final TopicSubscriptionManagerLogger TOPIC_SUBSCRIPTION_MANAGER_LOGGER =
    createLogger(TopicSubscriptionManagerLogger.class, PROJECT_CODE, PROJECT_LOGGER, "02");
