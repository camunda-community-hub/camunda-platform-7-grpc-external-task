# gRPC API for Camunda BPM Runtime External Tasks [![Build Status](https://travis-ci.com/tmetzke/camunda-bpm-grpc-external-task.svg?branch=master)](https://travis-ci.com/tmetzke/camunda-bpm-grpc-external-task)
